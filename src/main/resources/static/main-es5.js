...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function globalConfigTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var CSV_RESPONSE_HEADERS = ['id', 'response_time_in_millis', 'specific_second_of_communication', 'version_response', 'size']; //-----------------------   Global options for application which you can modify    -------------------------
    // 1) URLS
    // domain for server (http2)
    // export const HTTP_URL_MAIN = 'https://localhost:8080';

    var HTTP_URL_MAIN = 'https://83.229.84.77:8080'; // websocket(stomp) URL for connection

    var WEBSOCKET_URL_MAIN = 'ws://localhost:8080/socket'; // export const WEBSOCKET_URL_MAIN = 'ws://83.229.84.77:8080/socket';
    // rsocket(websocket) URL for connection
    // export const RSOCKET_URL_MAIN =  'ws://localhost:8080/rsocket';

    var RSOCKET_URL_MAIN = 'ws://83.229.84.77:8080/rsocket'; // 3) Serializer for RSocket
  ...
  function srcAppCacheMeasurementServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      _createClass(MeasurementService, [{
        ...
        value: function addMeasurementResponse(id, responseTimeInMillis, specificSecondOfCommunication, version, size) {
          // if (this.measurements.length > 1999) {
          //     this.measurements.splice(0, 1);
          // }
          this.measurements.push(new _model_MeasurementResponse__WEBPACK_IMPORTED_MODULE_1__["MeasurementResponse"](id, responseTimeInMillis, specificSecondOfCommunication, version, size));
        }
      }, {
    ...
    function () {
      ...
      _createClass(ProtobufFormatter, [{
        ...
        value: function encode(data) {
          ...
          var newData = new Array(data.additionalData.length);
  ...
  /***/
  "./src/app/communication/rsocket/rsocket.service.ts":
  /*!**********************************************************!*\
    !*** ./src/app/communication/rsocket/rsocket.service.ts ***!
    \**********************************************************/
  ...
  /***/
  function srcAppCommunicationRsocketRsocketServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var rsocket_websocket_client__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! rsocket-websocket-client */
    "./node_modules/rsocket-websocket-client/build/index.js");
    /* harmony import */


    var rsocket_websocket_client__WEBPACK_IMPORTED_MODULE_2___default =
    /*#__PURE__*/
    __webpack_require__.n(rsocket_websocket_client__WEBPACK_IMPORTED_MODULE_2__);
    /* harmony import */


    var rsocket_core__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! rsocket-core */
    "./node_modules/rsocket-core/build/index.js");
    /* harmony import */


    var rsocket_core__WEBPACK_IMPORTED_MODULE_3___default =
    /*#__PURE__*/
    __webpack_require__.n(rsocket_core__WEBPACK_IMPORTED_MODULE_3__);
    /* harmony import */
    ...
    var _SocketClientState__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ../SocketClientState */
    "./src/app/communication/SocketClientState.ts");
    /* harmony import */


    var _global_config__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ../../../../global-config */
    "./global-config.ts");
    /* harmony import */


    var _format_JsonFormatter__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    ...
    function (_Communicator__WEBPAC) {
      _inherits(RsocketService, _Communicator__WEBPAC);

      var _super = _createSuper(RsocketService);

      function RsocketService(measurementService, requestCache) {
        var _this;

        _classCallCheck(this, RsocketService);

        _this = _super.call(this, _global_config__WEBPACK_IMPORTED_MODULE_6__["RSOCKET_URL_MAIN"]);
        _this.measurementService = measurementService;
        _this.requestCache = requestCache; // right now only support for json

        _this.setFormatter(new _format_JsonFormatter__WEBPACK_IMPORTED_MODULE_7__["JsonFormatter"]());
      ...
      _createClass(RsocketService, [{
        ...
        value: function initializeConnection() {
          ...
          this.client = new rsocket_core__WEBPACK_IMPORTED_MODULE_3__["RSocketClient"]({
            serializers: {
              data: _global_config__WEBPACK_IMPORTED_MODULE_6__["SERIALIZER_DATA"],
              metadata: _global_config__WEBPACK_IMPORTED_MODULE_6__["SERIALIZER_METADATA"]
            },
            setup: {
              ...
              lifetime: 180000,
              // format of `data`
              dataMimeType: _global_config__WEBPACK_IMPORTED_MODULE_6__["DATA_MIME_TYPE"],
              // format of `metadata`
            ...
            transport: new rsocket_websocket_client__WEBPACK_IMPORTED_MODULE_2___default.a({
              url: this.serverUrl
            })
          });
          this.state = new rxjs__WEBPACK_IMPORTED_MODULE_4__["BehaviorSubject"](_SocketClientState__WEBPACK_IMPORTED_MODULE_5__["SocketClientState"].ATTEMPTING);
          this.client.connect().subscribe({
            onComplete: function onComplete(socket) {
              _this2.rsocketObject = socket;
              socket.requestStream({
                ...
                onError: function onError(error) {
                  ...
                  _this2.state.next(_SocketClientState__WEBPACK_IMPORTED_MODULE_5__["SocketClientState"].ERROR);
                },
                onNext: function onNext(payload) {
                  _this2.measurementService.addMeasurementResponse(payload.data.id, 0, 0, 0, 0);

                  _this2.monsterToUpdate.next(payload.data);
                },
                onSubscribe: function onSubscribe(subscription) {
                  console.error('========= Subskrybuje monsterUpdate ============');
                  subscription.request(2147483640);
                  _this2.monstersUpdateSub = subscription;
                }
              });
              socket.requestStream({
                ...
                onNext: function onNext(payload) {
                  ...
                  _this2.playersToAdd.next(payload.data);
                },
                onSubscribe: function onSubscribe(subscription) {
                  console.error('======== Subskrybuje playersAdded ===========');
                  subscription.request(2147483641);
                  _this2.playersAddedSub = subscription;
                }
              });
              socket.requestStream({
                ...
                onNext: function onNext(payload) {
                  _this2.playerToRemove.next(payload.data);
                },
                onSubscribe: function onSubscribe(subscription) {
                  console.error('========= Subskrybuje playerRemove ============');
                  subscription.request(2147483642);
                  _this2.playerRemoveSub = subscription;
                }
              });
              socket.requestStream({
                ...
                onNext: function onNext(playerToUpdate) {
                  var parsedPlayer = playerToUpdate.data;
                  var responseTimeInMillis = new Date().getTime() - Number(playerToUpdate.data.requestTimestamp); // console.error("Odpowiedz serwera " + responseTimeInMillis + " milliseconds")

                  _this2.measurementService.addMeasurementResponse(parsedPlayer.nickname, responseTimeInMillis, playerToUpdate.data.requestTimestamp, parsedPlayer.version, playerToUpdate.data.contentLength);
                ...
                onSubscribe: function onSubscribe(subscription) {
                  ...
                  _this2.playerUpdateSub = subscription;
                }
              });
              socket.requestStream({
                data: _this2.formatter.prepareNicknamePayload(_this2.myNickname),
                ...
                onNext: function onNext(playerToUpdate) {
                  ...
                  var parsedPlayer = playerToUpdate.data;
                  var responseTimeInMillis = new Date().getTime() - Number(playerToUpdate.data.requestTimestamp);
                ...
                onSubscribe: function onSubscribe(subscription) {
                  ...
                  _this2.playerUpdateUserSub = subscription;
                }
              });
              socket.requestStream({
                ...
                onNext: function onNext(payload) {
                  _this2.coinToGet.next(payload.data);
                },
                onSubscribe: function onSubscribe(subscription) {
                  console.error('========= Subskrybuje coinGet ============');
                  subscription.request(2147483645);
                  _this2.coinGetSub = subscription;
                }
              });
              socket.requestStream({
                ...
                onSubscribe: function onSubscribe(subscription) {
                  ...
                  _this2.coinRefreshSub = subscription;
                }
              });

              _this2.state.next(_SocketClientState__WEBPACK_IMPORTED_MODULE_5__["SocketClientState"].CONNECTED);
            },
            onError: function onError(error) {
              console.log(error);
        ...
        value: function joinToGame(nickname) {
          ...
          this.rsocketObject.requestResponse({
            metadata: String.fromCharCode('joinToGame'.length) + 'joinToGame'
          }).subscribe({
            onComplete: function onComplete(currentCoinPosition) {
              _this3.ifJoinGame.next(currentCoinPosition.data);
            },
            onError: function onError(error) {
              console.log('got error with requestResponse');
              console.error(error);

              _this3.state.next(_SocketClientState__WEBPACK_IMPORTED_MODULE_5__["SocketClientState"].ERROR);
            }
          });
        }
      }, {
        ...
        value: function sendPosition(dataToSend) {
          var encodedData = this.formatter.encode(dataToSend);
    ...
    RsocketService.ɵfac = function RsocketService_Factory(t) {
      return new (t || RsocketService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_cache_measurement_service__WEBPACK_IMPORTED_MODULE_8__["MeasurementService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_cache_request_cache_service__WEBPACK_IMPORTED_MODULE_9__["RequestCacheService"]));
    };
  ...
  function srcAppCommunicationWebsocketWebsocketServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function (_Communicator__WEBPAC2) {
      ...
      function WebsocketService(measurementService, requestCache) {
        ...
        _this4 = _super2.call(this, _global_config__WEBPACK_IMPORTED_MODULE_7__["WEBSOCKET_URL_MAIN"]);
        _this4.measurementService = measurementService;
        _this4.requestCache = requestCache;
        _this4.variable = _this4.makeid(30000);

        _this4.setFormatter(new _format_ProtobufFormatter__WEBPACK_IMPORTED_MODULE_6__["ProtobufFormatter"]());
      ...
      _createClass(WebsocketService, [{
        ...
        value: function initializeConnection() {
          ...
          this.stompClient.onConnect = function (frame) {
            ...
            _this5.stompClient.subscribe('/pacman/add/players', function (gameToAddPlayer) {
              _this5.playersToAdd.next(JSON.parse(gameToAddPlayer.body));

              console.error('Zaktualizowano gre, dodano gracza');
            });

            _this5.stompClient.subscribe('/pacman/remove/player', function (playerToRemove) {
              _this5.playerToRemove.next(_this5.formatter.decodePlayer(playerToRemove));

              console.error('Zaktualizowano gre, usunieto gracza');
            });

            _this5.stompClient.subscribe('/pacman/update/player', function (playerToUpdate) {
              var parsedPlayer = _this5.formatter.decodePlayer(playerToUpdate);
              ...
              _this5.measurementService.addMeasurementResponse(parsedPlayer.nickname, responseTimeInMillis, Math.ceil((Number(playerToUpdate.headers.requestTimestamp) - _this5.requestCache.timeForStartCommunication) / 1000), parsedPlayer.version, playerToUpdate.headers.contentLength);

              if (parsedPlayer.nickname === _this5.myNickname) {
                var request = _this5.requestCache.getRequest(parsedPlayer.version);

                _this5.updateScore.next(parsedPlayer.score);

                if (request !== null && (request.x !== parsedPlayer.positionX || request.y !== parsedPlayer.positionY)) {
                  _this5.playerToUpdate.next(parsedPlayer);
                }
              } else {
                _this5.playerToUpdate.next(parsedPlayer);
              }
            ...
            _this5.stompClient.subscribe('/pacman/update/monster', function (monster) {
              var monsterParsed = _this5.formatter.decodeMonster(monster);

              _this5.measurementService.addMeasurementResponse(monsterParsed.id, 0, 0, 0, 0);

              _this5.monsterToUpdate.next(monsterParsed);
            });

            _this5.stompClient.subscribe('/pacman/refresh/coins', function () {
              _this5.refreshCoin.next();
            });

            _this5.stompClient.subscribe('/pacman/get/coin', function (coinPosition) {
              _this5.coinToGet.next(_this5.formatter.decodeCoin(coinPosition));
            });

            _this5.stompClient.subscribe('/user/queue/reply', function (currentCoinPosition) {
              _this5.ifJoinGame.next(JSON.parse(currentCoinPosition.body));
            });

            _this5.stompClient.subscribe('/user/queue/player', function (playerToUpdate) {
              var parsedPlayer = _this5.formatter.decodePlayer(playerToUpdate);
              ...
              var request = _this5.requestCache.getCorrectedPosition(parsedPlayer.version);
            ...
            _this5.stompClient.subscribe('/pacman/collision/update', function (allCoinPosition) {});

            _this5.state.next(_SocketClientState__WEBPACK_IMPORTED_MODULE_3__["SocketClientState"].CONNECTED);
          };
  ...
  function srcAppModelMeasurementResponseTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function MeasurementResponse(id, response_time_in_millis, specific_second_of_communication, version_response, size) {
  ...
  function srcAppModelPlayerTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function (_phaser__WEBPACK_IMPO) {
      ...
      function Player(scene, x, y, texture, score, version) {
        ...
        _this6 = _super3.call(this, scene, x, y, texture); // Dodanie gracza do sceny (zeby w ogole byl widoczny)

        scene.add.existing(_assertThisInitialized(_this6)); // Dodanie gracza do fizyki co pozwala na ustawianie interakcji

        scene.physics.add.existing(_assertThisInitialized(_this6)); // Dodanie kolidera na graczu oraz warstwie

        scene.physics.add.collider(_assertThisInitialized(_this6), scene.backgroundLayer); // scene.anims.play('myUp');

        _this6._score = score;
        _this6._version = version;
        return _this6;
      }
  ...
  function srcAppScenesMainSceneMainSceneComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function (_phaser__WEBPACK_IMPO2) {
      ...
      function MainSceneComponent(websocketService, router, renderer, downloadService, requestCache) {
        ...
        _this7.websocketService = websocketService;
        _this7.router = router;
        _this7.renderer = renderer;
        _this7.downloadService = downloadService;
        _this7.requestCache = requestCache; // Additional data for testing changing data size

        _this7.additionalData = _this7.randomString(50, '0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ');
        _this7.arrayWithAdditionalData = new Array(2); // Game objects

        _this7.players = new Map();
        _this7.monsters = new Map();
        _this7.rank = new Array(); // Sending objects

        _this7.startSendingPlayerPosition = false;
        _this7.counterRequest = 0;
        _this7.scoreRanking = new Map();

        if (_this7.router.getCurrentNavigation().extras.state) {
          _this7.myPlayerName = _this7.router.getCurrentNavigation().extras.state.nick;
          _this7.websocketService.myNickname = _this7.myPlayerName;
        } else {
      ...
      _createClass(MainSceneComponent, [{
        ...
        value: function startGame() {
          ...
          for (var i = 0; i < this.arrayWithAdditionalData.length; i++) {
            this.arrayWithAdditionalData[i] = new _communication_simulation_data_AdditionalData__WEBPACK_IMPORTED_MODULE_8__["AdditionalData"](11111, 22222, 33333, this.additionalData);
          }
          ...
          this.stateSubscription = this.websocketService.getState().subscribe(function (state) {
            if (state === _communication_SocketClientState__WEBPACK_IMPORTED_MODULE_6__["SocketClientState"].CONNECTED) {
              _this8.ifJoinToGameSubscription = _this8.websocketService.getIfJoinGame().subscribe(function (currentCoinPosition) {
                if (currentCoinPosition.length > 0) {
                  ...
                  try {
                    for (_iterator.s(); !(_step = _iterator.n()).done;) {
                      ...
                      _this8.coins.create(coinPosition.positionX * 32 + 16, coinPosition.positionY * 32 - 16, "coin", null, true, true);
                    }
                  } catch (err) {
                    _iterator.e(err);
                  } finally {
              ...
              _this8.websocketService.joinToGame(_this8.myPlayerName);
        ...
        value: function create() {
          ...
          this.updateScoreSubscription = this.websocketService.getUpdateScore().subscribe(function (myScore) {
            _this9.players.get(_this9.myPlayerName).score = myScore;

            _this9.yourScore.setText(_this9.myPlayerName + " score: " + myScore);
          }); // Jeszcze trzeba zaimplementowac

          this.refreshCoinsSubscription = this.websocketService.getRefreshCoins().subscribe(function () {
            _this9.coinLayer.forEach(function (object) {
              var obj = _this9.coins.create(object.x + 16, object.y - 16, "coin");
          ...
          this.downloadButton.on('pointerup', function () {
            ...
            _this9.downloadService.downloadResponseMeasurements();
        ...
        value: function managePlayersInGame() {
          ...
          this.playersToAddSubscription = this.websocketService.getPlayersToAdd().subscribe(function (playersToAdd) {
            ...
            _this10.rank.length = 4;

            _this10.scoreNumber1.setText("NO_ONE");

            _this10.scoreNumber2.setText("NO_ONE");

            _this10.scoreNumber3.setText("NO_ONE");
            ...
            try {
              for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
                ...
                if (counter < 4) {
                  _this10.rank[counter - 1] = player;

                  _this10.setScoreText(counter, player);
                }

                if (!_this10.players.has(player.nickname)) {
                  if (player.nickname !== _this10.myPlayerName) {
                    _this10.players.set(player.nickname, new _model_Player__WEBPACK_IMPORTED_MODULE_2__["Player"](_this10, player.positionX, player.positionY, 'other-player', player.score, -1));

                    console.error('Dodaje gracza ' + player.nickname);

                    _this10.players.get(player.nickname).anims.play('enemyAnim');
                  } else {
                    _this10.players.set(player.nickname, new _model_Player__WEBPACK_IMPORTED_MODULE_2__["Player"](_this10, player.positionX, player.positionY, 'my-player', player.score, -1));

                    _this10.startSendingPlayerPosition = true;
                    _this10.yourScore = _this10.add.text(32, 32, _this10.myPlayerName + " score: " + player.score, {
                      font: "30px Arial",
                      fill: "#ff0044",
                      align: "center"
                    }); // Uruchomienie animacji wczesniej przygotowanej

                    _this10.players.get(player.nickname).anims.play('myAnim');

                    _this10.requestCache.lastCorrectRequest = new _model_Request__WEBPACK_IMPORTED_MODULE_7__["Request"](0, player.positionX, player.positionY);
                    _this10.requestCache.timeForStartCommunication = new Date().getTime();

                    _this10.sendPlayerPosition();
                  }

                  _this10.physics.add.overlap(_this10.players.get(player.nickname), _this10.coins, _this10.collectCoin, null, _this10);
                }
              }
            } catch (err) {
              _iterator2.e(err);
          ...
          this.playerToRemoveSubscription = this.websocketService.getPlayerToRemove().subscribe(function (playerToRemove) {
            _this10.rank = _this10.rank.filter(function (item) {
              return item.nickname !== playerToRemove.nickname;
            });
            console.error("Po srpawdzeniu rankingu");

            if (playerToRemove.nickname === _this10.myPlayerName) {
              _this10.cleanAndBackToHomePage();
            }

            _this10.players.get(playerToRemove.nickname).destroy(true);

            _this10.players["delete"](playerToRemove.nickname);
          });
          this.playerToUpdateSubscription = this.websocketService.getPlayerToUpdate().subscribe(function (player) {
            var currentPlayer = _this10.players.get(player.nickname);

            if (currentPlayer) {
              _this10.changeAnimationFrameForOtherPlayers(player, currentPlayer);

              console.error(currentPlayer.version);
              console.error(player.version);
        ...
        value: function sendPlayerPosition() {
          ...
          //         this.arrayWithAdditionalData.push(new AdditionalData(5555,this.additionalData));
          //     }
          //
          ...
          //
          //     }, 1, 10000);
          var player = this.players.get(this.myPlayerName);
          this.lastX = player.x;
          this.lastY = player.y;
          ...
          //     }
          //     //57 tys
          //     if(this.arrayWithAdditionalData.length > 800) {
          ...
          this.positionSenderSubscription = this.positionSender.subscribe(function () {
            var player = _this11.players.get(_this11.myPlayerName);

            if (_this11.lastX !== player.x || _this11.lastY !== player.y || _this11.lastAngle !== player.angle) {
              _this11.lastX = player.x;
              _this11.lastY = player.y;
              _this11.lastAngle = player.angle;

              _this11.requestCache.addRequest(++_this11.counterRequest, player.x, player.y);

              _this11.websocketService.sendPosition({
                "nickname": _this11.myPlayerName,
                "positionX": player.x,
                "positionY": player.y,
                "score": player.score,
                "stepDirection": _this11.getDirection(),
                "version": _this11.counterRequest // "additionalData": this.arrayWithAdditionalData
        ...
        value: function checkRanking() {
          ...
          playersArray.forEach(function (element) {
            _this12.setScoreText(counter, element);
        ...
        value: function manageMonstersInGame() {
          ...
          this.monsterToUpdateSubscription = this.websocketService.getMonsterToUpdate().subscribe(function (monsterToUpdate) {
            if (_this13.monsters.has(monsterToUpdate.id)) {
              _this13.monsters.get(monsterToUpdate.id).x = monsterToUpdate.positionX;
              _this13.monsters.get(monsterToUpdate.id).y = monsterToUpdate.positionY;
            } else {
              _this13.monsters.set(monsterToUpdate.id, _this13.physics.add.sprite(monsterToUpdate.positionX, monsterToUpdate.positionY, 'monster'));

              _this13.monsters.get(monsterToUpdate.id).anims.play('animation');
            }
          });
        } ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  function srcEnvironmentsEnvironmentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _app_communication_rsocket_rsocket_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
    /*! ../app/communication/rsocket/rsocket.service */
    "./src/app/communication/rsocket/rsocket.service.ts");

    var environment = {
      production: false,
      serviceToCommunication: _app_communication_rsocket_rsocket_service__WEBPACK_IMPORTED_MODULE_0__["RsocketService"]
    };
    /***/
  },
