...
const CSV_RESPONSE_HEADERS = ['id', 'response_time_in_millis', 'specific_second_of_communication', 'version_response', 'size'];
...
const HTTP_URL_MAIN = 'https://83.229.84.77:8080';
...
const RSOCKET_URL_MAIN = 'ws://83.229.84.77:8080/rsocket';
...
class ProtobufFormatter {
    ...
    encode(data) {
        ...
        const newData = new Array(data.additionalData.length);
...
/* harmony import */ var rsocket_websocket_client__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! rsocket-websocket-client */ "./node_modules/rsocket-websocket-client/build/index.js");
/* harmony import */ var rsocket_websocket_client__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(rsocket_websocket_client__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var rsocket_core__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! rsocket-core */ "./node_modules/rsocket-core/build/index.js");
/* harmony import */ var rsocket_core__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(rsocket_core__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! rxjs */ "./node_modules/rxjs/_esm2015/index.js");
/* harmony import */ var _SocketClientState__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../SocketClientState */ "./src/app/communication/SocketClientState.ts");
/* harmony import */ var _global_config__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../../global-config */ "./global-config.ts");
/* harmony import */ var _format_JsonFormatter__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../format/JsonFormatter */ "./src/app/communication/format/JsonFormatter.ts");
...
class RsocketService extends _Communicator__WEBPACK_IMPORTED_MODULE_1__["Communicator"] {
    constructor(measurementService, requestCache) {
        super(_global_config__WEBPACK_IMPORTED_MODULE_6__["RSOCKET_URL_MAIN"]);
        this.measurementService = measurementService;
        this.requestCache = requestCache;
        // right now only support for json
        this.setFormatter(new _format_JsonFormatter__WEBPACK_IMPORTED_MODULE_7__["JsonFormatter"]());
    }
        ...
        this.client.connect().subscribe({
            onComplete: socket => {
                ...
                socket.requestStream({
                    ...
                    onError: error => {
                        console.log(error);
                        this.state.next(_SocketClientState__WEBPACK_IMPORTED_MODULE_5__["SocketClientState"].ERROR);
                    },
                    onNext: payload => {
                ...
                socket.requestStream({
                    ...
                    onNext: playerToUpdate => {
                        const parsedPlayer = playerToUpdate.data;
                        ...
                        this.measurementService.addMeasurementResponse(parsedPlayer.nickname, responseTimeInMillis, playerToUpdate.data.requestTimestamp, parsedPlayer.version, playerToUpdate.data.contentLength);
                ...
                this.state.next(_SocketClientState__WEBPACK_IMPORTED_MODULE_5__["SocketClientState"].CONNECTED);
            },
            onError: error => {
                console.log(error);
                this.state.next(_SocketClientState__WEBPACK_IMPORTED_MODULE_5__["SocketClientState"].ERROR);
...
RsocketService.ɵfac = function RsocketService_Factory(t) { return new (t || RsocketService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_cache_measurement_service__WEBPACK_IMPORTED_MODULE_8__["MeasurementService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_cache_request_cache_service__WEBPACK_IMPORTED_MODULE_9__["RequestCacheService"])); };
    ...
    initializeConnection() {
        ...
        this.stompClient.onConnect = (frame) => {
            ...
            this.stompClient.subscribe('/pacman/update/player', (playerToUpdate) => {
                ...
                // console.error("Odpowiedz serwera " + responseTimeInMillis + " milliseconds")
                this.measurementService.addMeasurementResponse(parsedPlayer.nickname, responseTimeInMillis, Math.ceil((Number(playerToUpdate.headers.requestTimestamp) - this.requestCache.timeForStartCommunication) / 1000), parsedPlayer.version, playerToUpdate.headers.contentLength);
                if (parsedPlayer.nickname === this.myNickname) {
                    const request = this.requestCache.getRequest(parsedPlayer.version);
                    this.updateScore.next(parsedPlayer.score);
                    if (request !== null && (request.x !== parsedPlayer.positionX || request.y !== parsedPlayer.positionY)) {
...
class MeasurementResponse {
    constructor(id, response_time_in_millis, specific_second_of_communication, version_response, size) {
        this._id = id;
...
class MainSceneComponent extends phaser__WEBPACK_IMPORTED_MODULE_1___default.a.Scene {
    constructor(websocketService, router, renderer, downloadService, requestCache) {
        ...
        this.arrayWithAdditionalData = new Array(2);
        // Game objects
...
/* harmony import */ var _app_communication_rsocket_rsocket_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../app/communication/rsocket/rsocket.service */ "./src/app/communication/rsocket/rsocket.service.ts");
